 ...
 */
unsigned long _jit_function_get_bytecode(jit_function_t func, jit_function_info_t func_info, void *pc, int exact);
...
jit_function_t _jit_memory_get_function(jit_context_t context, jit_function_info_t func_info);
void *_jit_memory_get_function_start(jit_context_t context, jit_function_info_t func_info);
void *_jit_memory_get_function_end(jit_context_t context, jit_function_info_t func_info);
